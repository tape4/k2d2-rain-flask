...
# CSV 파일 읽기
df = pd.read_csv('/home/ubuntu/rain_api/csv_files/interpolated_output_data_cubic.csv', header=None)
...
def index_to_coordinates(row_idx, col_idx, central_lat, central_lon, lat_step_m=500, lon_step_m=500):
...
# JSON 파일로 저장
with open('/home/ubuntu/rain_api/result/filtered_coordinates.json', 'w') as json_file:
